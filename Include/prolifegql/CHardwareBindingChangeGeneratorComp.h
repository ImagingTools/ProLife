...
class CHardwareBindingChangeGeneratorComp: public imtbase::CDocumentChangeGeneratorCompBase
{
public:
	typedef imtbase::CDocumentChangeGeneratorCompBase BaseClass;

	I_BEGIN_COMPONENT(CHardwareBindingChangeGeneratorComp)
		...
		I_ASSIGN(m_deviceCollectionCompPtr, "DeviceCollection", "Device collection", false, "DeviceCollection");
	I_END_COMPONENT
...
protected:
	...
	virtual QString GetHardwareName(const QByteArray& hardwareId) const;
