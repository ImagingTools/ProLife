...
class CProductDatabaseDelegateComp: public imtdb::CSqlDatabaseObjectDelegateCompBase
{
public:
	typedef imtdb::CSqlDatabaseObjectDelegateCompBase BaseClass;

	I_BEGIN_COMPONENT(CProductDatabaseDelegateComp)
		I_ASSIGN(m_productInfoFactCompPtr, "ProductInfo", "Factory used for creation of the new Product instance", true, "ProductInfo");
	I_END_COMPONENT
...
private:
	I_FACT(prolifeauth::IProductInfo, m_productInfoFactCompPtr);
};
