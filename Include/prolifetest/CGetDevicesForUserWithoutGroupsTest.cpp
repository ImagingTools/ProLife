#include "CGetOrdersForUserWithoutGroupsTest.h"
...
imtbase::CTreeItemModel* CGetOrdersForUserWithoutGroupsTest::CreateExpectedModel() const
{
...
imtgql::CGqlRequest* CGetOrdersForUserWithoutGroupsTest::CreateGqlRequest() const
{
...
I_ADD_TEST(CGetOrdersForUserWithoutGroupsTest);
