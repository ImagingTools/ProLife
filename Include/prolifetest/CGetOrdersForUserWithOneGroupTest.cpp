...
#include "CGetOrdersForUserWithOneGroupTest.h"
...
imtbase::CTreeItemModel* CGetOrdersForUserWithOneGroupTest::CreateExpectedModel() const
{
	...
	notificationModelPtr->SetData("TotalCount", 2);

	return expectedModelPtr.PopPtr();
}


imtgql::CGqlRequest* CGetOrdersForUserWithOneGroupTest::CreateGqlRequest() const
{
	...
	userInfoPtr->SetId("UserWithGroup");
...
I_ADD_TEST(CGetOrdersForUserWithOneGroupTest);
