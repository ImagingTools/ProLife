// Software (SoftwareProducts) EDITOR - full functional coverage.
//
...
// permission-driven (SoftwareEditor.checkPermissions), which the screenshots + the structural
// "editable fields" test record.
//
...
test.describe('Software / editor', () => {
  ...
  test.describe.serial('edit document', () => {
    ...
    test('edit fields and save', { tag: '@mutating' }, async () => {
      ...
      // identical note in devices.editor.test.js.
