...
// None of this opens a document tab (it's a plain modal dialog), so the default per-test `page`
// fixture (its own fresh context) is enough, which also means a Logout in one test can't affect any
// other test's page.
...
test.describe('User profile', () => {
  ...
  test('access tokens: generate, copy, appears in the list, revoke, then delete', async ({ page, gui }) => {
    ...
    // a per-run number means they never match.
