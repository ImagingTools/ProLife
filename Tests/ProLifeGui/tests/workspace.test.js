// Workspace page. Runs as its own `workspace` user (see fixtures/users.js), so its baselines live in
// tests/__screenshots__/workspace/.
...
test.describe('Workspace', () => {
  ...
  test.describe('cold load', () => {
    ...
    // Landing state - what the user sees right after sign-in, before any navigation.
